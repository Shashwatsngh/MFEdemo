      ...
      <div>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30 rounded-xl p-6">
          ...
          <p className="text-red-600 dark:text-red-300/80 mb-6 text-sm">
            Deleting your account is permanent. All your data, learning
            progress, and certificates will be wiped out immediately.
          </p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-8 pb-8">
          <div className="relative flex flex-col sm:flex-row items-end -mt-16 mb-6 gap-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors shadow-sm"
              >
                Edit Profile
              </button>
            </div>
          ...
          <div className="flex gap-4 border-t border-gray-100 dark:border-gray-700 pt-8 mt-8">
            <button
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    {profile.stats.totalHoursLearned}
                  </div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-1">
                    Hours Learned
                  </div>
